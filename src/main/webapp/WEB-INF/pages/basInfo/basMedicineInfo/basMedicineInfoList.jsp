...
<script type="text/javascript"	src="/HRERP/resources/js/basInfo/basMedicineInfo.js"></script>
					...
					<form id="searchForm" onsubmit="return false;">
						<div class="float-l">
							...
							<div class="l-panel-search-item">
								<input id="search_medicine_code" name="medicine_code" type="text" />
							</div>
						</div>
						<div class="float-l">
							<div class="l-panel-search-title">药品名称：</div>
							<div class="l-panel-search-item">
								<input id="search_medicine_name" name="medicine_name"
									type="text" />
							</div>
						</div>
						<div class="float-l">
							<div class="l-panel-search-title">药品拼音码：</div>
							<div class="l-panel-search-item">
								<input id="search_medicine_chnpy" name="medicine_chnpy"
									type="text" />
							</div>
						</div>
					</form>
