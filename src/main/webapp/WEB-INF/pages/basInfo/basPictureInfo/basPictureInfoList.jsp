...
<script type="text/javascript" src="/HRERP/resources/js/basInfo/basPictureInfo.js"></script>
			...
			<div class="l-searchbar clearfix centertoolbar-w1">
				<div class="l-panel-search-cond clearfix">
					<form id="searchForm" onsubmit="return false;">
						<div class="float-l">
							<div class="l-panel-search-title">图片名称：</div>
							<div class="l-panel-search-item">
								<input id="search_picture_name" name="picture_name" type="text" />
							</div>
						</div>
						<div class="float-l">
							<div class="l-panel-search-title">图片备注：</div>
							<div class="l-panel-search-item">
								<input id="search_picture_remark" name="picture_remark" type="text" />
							</div>
						</div>
					</form>
				</div>
