...
<script type="text/javascript" src="/HRERP/resources/js/basInfo/basFactoryInfo.js"></script>
			...
			<div class="l-searchbar clearfix centertoolbar-w1">
				<div class="l-panel-search-cond clearfix">
					<form id="searchForm" onsubmit="return false;">
						<div class="float-l">
							<div class="l-panel-search-title">厂家编码：</div>
							<div class="l-panel-search-item">
								<input id="search_factory_code" name="factory_code" type="text" />
							</div>
						</div>
						<div class="float-l">
							<div class="l-panel-search-title">简称：</div>
							<div class="l-panel-search-item">
								<input id="search_factory_shortname" name="factory_shortname" type="text" />
							</div>
						</div>
						<div class="float-l">
							<div class="l-panel-search-title">拼音码 ：</div>
							<div class="l-panel-search-item">
								<input id="search_factory_chnpy" name="factory_chnpy" type="text" />
							</div>
						</div>
					</form>
				</div>
