...
<script type="text/javascript" src="/HRERP/resources/js/basInfo/ethicalPerson.js"></script>
...
<body>
	<div id="mainContent" class="easyui-layout" fit="true"
			...
			<div class="l-searchbar clearfix centertoolbar-w1">
				<div class="l-panel-search-cond clearfix">
					<form id="searchForm" onsubmit="return false;">
						<div class="float-l">
							<div class="l-panel-search-title">人员编号：</div>
							<div class="l-panel-search-item">
								<input id="search_ethical_personCode" name="ethical_personCode" type="text" />
							</div>
						</div>
						<div class="float-l">
							<div class="l-panel-search-title">人员姓名：</div>
							<div class="l-panel-search-item">
								<input id="search_ethical_personCode" name="ethical_personCode" type="text" />
							</div>
						</div>
		...
		<div data-options="region:'center',border:false"
			style="overflow: hidden;">
			<table id="ethicalPersonDg"></table>
		</div>
	</div>
	<!-- 编辑窗口 -->
