...
<script type="text/javascript" src="/HRERP/resources/js/basInfo/basDepartmentInfo.js"></script>
			...
			<div class="l-searchbar clearfix centertoolbar-w1">
				<div class="l-panel-search-cond clearfix">
					<form id="searchForm" onsubmit="return false;">
						<div class="float-l">
							<div class="l-panel-search-title">部门编号：</div>
							<div class="l-panel-search-item">
								<input id="search_department_number" name="department_number" type="text" />
							</div>
						</div>
					</form>
				</div>
