...
<script type="text/javascript" src="/HRERP/resources/js/log/logMenuPermissionCheck.js"></script>
</head>
<body>
					...
					<form id="searchForm" onsubmit="return false;">
						<div class="float-l">
							...
							<div class="l-panel-search-item">
								<input id="search_group_id" name="group_id" class="easyui-combobox" type="text" width="100%"/>
							</div>
						</div>
							<div class="float-l">
							<div class="l-panel-search-title">菜单名称：</div>
							<div class="l-panel-search-item">
								<input id="search_menu_name" name="menu_name" type="text" />
							</div>
						</div>
					</form>
				</div>
