...
$.extend($.fn.datagrid.methods, {
		...
		if(node!=null&&node!=""){
			//如果选择按批号出库，
				$("#stockBatchChoose").window({
     				...
     				collapsible : false,
     				resizable : false,
     				content : '<iframe style="width:100%;height:100%;border:0px;padding:0px;padding:0px;" src="/HRERP/retail/order/viewStockList?callback=setStockContent&product_id=' + node.product_id +'"></iframe>',
     			});
	...
	function setStockContent(stock){
		...
		node['stock_info_id'] = stock.stock_info_id;
