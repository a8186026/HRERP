	...
	<div region="center" border="false" class="Dialog-Bg">
		<div class="Dialog-formDiv clearfix">
			<form:form id="_form" action="${formUrl}" method="${method}">
				<input name="dict_id" type="hidden" value="${sysDictionary.dict_id}" />
				...
				<div class="float-l">
					...
					<div class="Dialog-form-item">
						<input id="dict_name" name="dict_name" class="easyui-validatebox"
							data-options="validType:'length[0,20]'"
							value="${sysDictionary.dict_name}" />
					</div>
				</div>
				<div class="float-l">
					<div class="Dialog-form-title">
						<label for="dict_code" class="field">编码：</label>
					</div>
					<div class="Dialog-form-item">
						<input id="dict_code" name="dict_code" type="text"
							class="easyui-validatebox"
							data-options="validType:'length[0,20]'"
							value="${sysDictionary.dict_code}" />
					</div>
				</div>
				<div class="float-l">
					<div class="Dialog-form-title">
					...
					<div class="Dialog-form-item">
						<textarea id="note" name="note" type="text"
							class="easyui-validatebox textareaW1" maxlength="100">${sysDictionary.note}</textarea>
					</div>
				</div>
			</form:form>
		</div>
