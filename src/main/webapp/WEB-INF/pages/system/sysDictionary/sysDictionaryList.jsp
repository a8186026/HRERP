...
<script type="text/javascript"
	src="/HRERP/resources/js/system/sysDictionary.js"></script>
</head>
<body>
					...
					<form id="searchForm" onsubmit="return false;">
						<div class="float-l">
							...
							<div class="l-panel-search-item">
								<input id="search_dict_name" name="dict_name" type="text" />
							</div>
						</div>
						<div class="float-l">
							<div class="l-panel-search-title">编码：</div>
							<div class="l-panel-search-item">
								<input id="search_dict_code" name="dict_code" type="text" />
							</div>
						</div>
					</form>
				</div>
