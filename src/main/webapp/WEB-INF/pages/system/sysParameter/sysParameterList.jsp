...
<script type="text/javascript"
	src="/HRERP/resources/js/system/sysParameter.js"></script>
</head>
<body>
			...
			<div class="l-searchbar clearfix centertoolbar-w1">
				<div class="l-panel-search-cond clearfix">
					<form id="searchForm" onsubmit="return false;">
						<div class="float-l">
							<div class="l-panel-search-title">名称：</div>
							<div class="l-panel-search-item">
								<input id="search_param_name" name="param_name" type="text" />
							</div>
						</div>
						<div class="float-l">
							<div class="l-panel-search-title">编码：</div>
							<div class="l-panel-search-item">
								<input id="search_param_code" name="param_code" type="text" />
							</div>
						</div>
					</form>
				</div>
