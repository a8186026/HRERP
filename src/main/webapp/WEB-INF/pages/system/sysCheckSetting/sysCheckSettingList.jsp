...
<script type="text/javascript"
	src="/HRERP/resources/js/system/sysCheckSetting.js"></script>
</head>
<body>
			...
			<div class="l-searchbar clearfix centertoolbar-w1">
				<div class="l-panel-search-cond clearfix">
					<form id="searchForm" onsubmit="return false;">
						<div class="float-l">
							<div class="l-panel-search-title">审核名称：</div>
							<div class="l-panel-search-item">
								<input id="search_check_name" name="check_name" type="text" />
							</div>
						</div>
							<div class="float-l">
							<div class="l-panel-search-title">审核编码：</div>
							<div class="l-panel-search-item">
								<input id="search_check_code" name="check_code" type="text" />
							</div>
						</div>
					</form>
				</div>
