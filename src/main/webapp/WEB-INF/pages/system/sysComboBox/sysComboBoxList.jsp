...
<script type="text/javascript" src="/HRERP/resources/js/system/sysComboBox.js"></script>
</head>
<body>
			...
			<div class="l-searchbar clearfix centertoolbar-w1">
				<div class="l-panel-search-cond clearfix">
					<form id="searchForm" onsubmit="return false;">
						<input id="cbs_type" type="hidden" value="${type}">
						<div class="float-l">
							<div class="l-panel-search-title">类别：</div>
							<div class="l-panel-search-item">
								<input id="search_cbs_pid" class="easyui-combobox" name="cbs_pid" type="text" />
							</div>
						</div>
						<div class="float-l">
							<div class="l-panel-search-title">编码：</div>
							<div class="l-panel-search-item">
								<input id="search_cbs_code" name="cbs_code" type="text" />
							</div>
						</div>
						<div class="float-l">
							<div class="l-panel-search-title">汉字：</div>
							<div class="l-panel-search-item">
								<input id="search_cbs_chn" name="cbs_chn" type="text" />
							</div>
						</div>
					</form>
				</div>
