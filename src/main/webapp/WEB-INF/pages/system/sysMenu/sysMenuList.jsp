...
<script type="text/javascript" src="/HRERP/resources/js/system/sysMenu.js"></script>
</head>
<body>
			...
			<div class="l-searchbar clearfix centertoolbar-w1">
				<div class="l-panel-search-cond clearfix">
					<form id="searchForm" onsubmit="return false;">
						...
						<div class="float-l">
							<div class="l-panel-search-title">菜单编码：</div>
							<div class="l-panel-search-item">
								<input id="search_menu_code" name="menu_code" type="text" />
							</div>
						</div>
					</form>
				</div>
