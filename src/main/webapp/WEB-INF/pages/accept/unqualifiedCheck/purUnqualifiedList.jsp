...
<script type="text/javascript" src="/HRERP/resources/js/accept/purUnqualified.js"></script>
			...
			<div class="l-searchbar clearfix centertoolbar-w1">
				<div class="l-panel-search-cond clearfix">
					<form id="searchForm" onsubmit="return false;">
						<div class="float-l">
							<div class="l-panel-search-title">订单编号：</div>
							<div class="l-panel-search-item">
								<input id="pur_order_id" name="pur_order_id" type="text" />
							</div>
						</div>
