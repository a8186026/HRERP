...
<script type="text/javascript"	src="/HRERP/resources/js/product/proPriceTag.js"></script>
</head>
<body>
					...
					<form id="searchForm" onsubmit="return false;">
						<div class="float-l">
							...
							<div class="l-panel-search-item">
								<input id="search_start_time" class="easyui-datebox" />
							</div>
						</div>
						<div class="float-l">
							<div class="l-panel-search-title">结束时间：</div>
							<div class="l-panel-search-item">
								<input id="search_end_time" class="easyui-datebox" />
							</div>
						</div>
					</form>
				</div>
