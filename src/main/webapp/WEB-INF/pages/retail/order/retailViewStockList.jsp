...
$.extend($.fn.datagrid.methods, {
	...
	$(function() {
		...
		$("#stock_dg").datagrid({
			...
			queryParams: {
				...
				stock_buyPresentSpecial:"${stock_buyPresentSpecial}"==""?null:"${stock_buyPresentSpecial}",
				type:"stock",//用于后台标识
			},
			columns:[[{
				field : 'product_name',
	...
	function chooseStock(){
		...
		if(node!=null&&node!=""){
			window.parent['${callbackStock}'](node);
