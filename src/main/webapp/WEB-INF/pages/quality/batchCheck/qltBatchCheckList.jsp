...
<title>重点批次信息管理</title>
<script src="/HRERP/resources/js/goldcow-all.js" type="text/javascript"></script>
<script type="text/javascript" src="/HRERP/resources/js/quality/qltBatchCheck.js"></script> 
</head>
<body>
				...
				<div class="l-panel-search-cond clearfix">
					<form id="searchForm" onsubmit="return false;">
						...
						<div class="float-l">
							...
							<div class="l-panel-search-item">
								<input id="search_batch_no" name="batch_no" type="text" />
							</div>
						</div>
					</form>
				</div>
