...
<title>不合格品种的报损</title>
<script src="/HRERP/resources/js/goldcow-all.js" type="text/javascript"></script>
<script type="text/javascript" src="/HRERP/resources/js/quality/qltDefectsInfoProfit.js"></script> 
</head>
<body>
	<div id="mainContent" class="easyui-layout" fit="true"
		...
		<div id="tb" style="padding:2px;height:auto">
			...
			<a id="profitLoss" href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="profitLoss()">报损申请</a>
			<a id="check" href="#" class="easyui-linkbutton" iconCls="icon-modify" plain="true" onclick="check()">直接报损</a>
			<a id="deleteFunc" href="#" class="easyui-linkbutton" iconCls="icon-delete" plain="true" onclick="deleteFunc()">删除</a>
			<font style="float:right">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			报损票号:&nbsp;&nbsp;<input id="defects_profitTicketNo" name="defects_profitTicketNo" readOnly="readonly" style="width: 100px;"/>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>
