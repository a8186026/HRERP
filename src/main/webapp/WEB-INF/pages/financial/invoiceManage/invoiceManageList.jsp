...
<script type="text/javascript" src="/HRERP/resources/js/financial/invoiceManage.js"></script>
...
<body>
	<div id="mainContent" class="easyui-layout" fit="true"
		...
		<div id="tb" style="padding:2px;height:auto">
			...
			<a href="#" class="easyui-linkbutton" iconCls="icon-modify" plain="true" onclick="modifyFunc()">修改</a>
		...
		<div data-options="region:'north',border:false,split:true" style="height:440px; border-bottom: 1px solid #ccc;" >
			...
			style="overflow: hidden;">
					<div class="l-searchbar clearfix centertoolbar-w1" style="width: 1100px;">
						<div class="l-panel-search-cond clearfix">
							<form id="searchForm" onsubmit="return false;">
								...
								<div class="float-l">
									...
									<div class="l-panel-search-item">
										<input id="rkfp_abstract" name="rkfp_abstract" type="text" />
									</div>
								</div>
								<div class="float-l">
	...
	<div id="editSumInvoiceWindow"></div>
</body>
</html>