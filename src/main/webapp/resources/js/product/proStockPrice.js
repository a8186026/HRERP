$(function() {
	...
	$("#PriceDg").datagrid({
		...
		columns:[[{
			...
			field : 'pro_trade_price',
			title : '批发价',
			width : 60,
			sortable : true
		},{
			field : 'pro_retail_price',
			title : '零售价',
			width : 60,
			sortable : true
		},{
			...
			field : 'pro_saleprice1',
			title : '销售价1',
			width : 60,
			sortable : true
		},{
			field : 'pro_saleprice2',
			title : '销售价2',
			width : 60,
			sortable : true
		},{
			field : 'pro_saleprice3',
			title : '销售价3',
			width : 60,
			sortable : true
		},{
			field : 'pro_saleprice4',
			title : '销售价4',
			width : 60,
			sortable : true
		},{
			field : 'pro_purchase_price',
			title : '进价',
			width : 60,
			sortable : true
		},{
			field : 'pro_market_price',
			title : '市场价',
			width : 60,
			sortable : true
		},{
			field : 'pro_cost_price',
			title : '成本价',
			width : 60,
			sortable : true
		},{
			field : 'pro_refer_purchase_price',
			title : '参考进价',
			width : 60,
			sortable : true
		},{
			field : 'pro_final_price',
			title : '结算价',
			width : 60,
			sortable : true
		},{
			field : 'pro_offer_price',
			title : '报价',
			width : 60,
			sortable : true
		}]],
	...
	$("#Prodg").datagrid({
		...
		onClickRow:function(index,data){
			$("#PriceDg").datagrid("options").url = global_param.context_name + "/product/stockPrice/getDeptsByPro",
...
function updateProFunc() {
	...
	util.openWindow('editWindow', "stockPrice/proPrice/" + node.product_id);
}