$(function() {
	...
	$("#dg").datagrid({
		method : 'get',
		url : global_param.context_name + "/quality/destruction/lists", // 数据来源
		title : '不合格品种销毁', // 标题
...
function destructionFunc() {
	var node = $('#dg').datagrid('getSelected');
	if (!node) {
		util.show("请选择一条记录");
		return;
	}
	util.openWindow('editWindow', "destruction/" + node.defects_id);
}
