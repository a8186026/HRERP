package com.goldcow.sframe.util.report;
...
import com.goldcow.sframe.util.report.grcommon;
...
public class GenDataBase {
	...
	public class mysql_jdbc_param{   
		...
		public final static String url = "jdbc:mysql://localhost/p2p?useUnicode=true&characterEncoding=utf8";   //"jdbc:mysql://localhost/gridreport?user=root&password=&useUnicode=true&characterEncoding=utf8"
		public final static String user = "root";   
		public final static String password = "123456";   
	}   

	//！注意：定义 mssql(sqlServer) 数据库访问参数，应修改为与实际一致
	public class mssql_jdbc_param{   
		public final static String driver = "com.microsoft.sqlserver.jdbc.SQLServerDriver";   //mssql2000 jdbc
		public final static String url = "jdbc:sqlserver://121.42.29.124:1433;databaseName=HRERP"; //mssql2000 jdbc 
		...
		public final static String password = "hrerp2015";   
	}   
