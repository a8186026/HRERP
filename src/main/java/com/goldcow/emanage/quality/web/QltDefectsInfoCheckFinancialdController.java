...
@Controller
@RequestMapping(value = "/quality/financiald")
public class QltDefectsInfoCheckFinancialdController {
	/** 不合格品种信息管理服务 */
	@Autowired
	...
	public String view(HttpServletRequest request) {
		if (SysUtil.hasRight(request, "qltDefectsInfoVO", GlobalVal.MENU_FUNCTION.VIEW)) {
			return "/quality/defectsInfoCheck/qltDefectsInfoCheckFinancialdList.jsp";
		} else {
	 ...
	 * @return 操作结果
	 */
	@RequestMapping(value = "financialdCheck", method = RequestMethod.GET)
	@ResponseBody
	public Map<String, Object> financialdCheck(HttpServletRequest request, String data) {
		Map<String, Object> result = Maps.newHashMap();
		request.getParameterMap();
		if (SysUtil.hasRight(request, "qltDefectsInfoVO", GlobalVal.MENU_FUNCTION.UPDATE)) {
			
			qltDefectsInfoService.financialdCheck(data, request);
