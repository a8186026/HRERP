...
@Controller
@RequestMapping(value = "/quality/storagetd")
public class QltDefectsInfoCheckStoragetdController {
	/** 不合格品种信息管理服务 */
	@Autowired
	...
	public String view(HttpServletRequest request) {
		if (SysUtil.hasRight(request, "qltDefectsInfoVO", GlobalVal.MENU_FUNCTION.VIEW)) {
			return "/quality/defectsInfoCheck/qltDefectsInfoCheckStoragetdList.jsp";
		} else {
	 ...
	 * @return 操作结果
	 */
	@RequestMapping(value = "storagetdCheck", method = RequestMethod.GET)
	@ResponseBody
	public Map<String, Object> storagetdCheck(HttpServletRequest request, String data) {
		Map<String, Object> result = Maps.newHashMap();
		request.getParameterMap();
		if (SysUtil.hasRight(request, "qltDefectsInfoVO", GlobalVal.MENU_FUNCTION.UPDATE)) {
			
			qltDefectsInfoService.storagetdCheck(data, request);
