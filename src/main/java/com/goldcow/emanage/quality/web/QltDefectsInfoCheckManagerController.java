...
@Controller
@RequestMapping(value = "/quality/manager")
public class QltDefectsInfoCheckManagerController {
	/** 不合格品种信息管理服务 */
	@Autowired
	...
	public String view(HttpServletRequest request) {
		if (SysUtil.hasRight(request, "qltDefectsInfoVO", GlobalVal.MENU_FUNCTION.VIEW)) {
			return "/quality/defectsInfoCheck/qltDefectsInfoCheckManagerList.jsp";
		} else {
	...
	@ResponseBody
	public Map<String, Object> managerCheck(HttpServletRequest request, String data) {
		Map<String, Object> result = Maps.newHashMap();
		request.getParameterMap();
		if (SysUtil.hasRight(request, "qltDefectsInfoVO", GlobalVal.MENU_FUNCTION.UPDATE)) {
			
			qltDefectsInfoService.managerCheck(data, request);
