 ...
 * @since 2015-6-2
 */
public class PmnDepartmentInfo extends DataGridModel implements BaseEntity {
	...
	public void setDepartment_memberday_integral(
			Integer department_memberday_integral) {
	...
	public void setDepartment_distributionweight(
			double department_distributionweight) {
	...
	public String getNoexecuteprice() {
		return noexecuteprice;
	}
	public void setNoexecuteprice(String noexecuteprice) {
		this.noexecuteprice = noexecuteprice;
	}
