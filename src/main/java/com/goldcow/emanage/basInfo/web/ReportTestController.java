 ...
 */
@Controller
@RequestMapping(value = "/basInfo/report")
public class ReportTestController {
	...
	public String view(HttpServletRequest request,Model model) {
		if (SysUtil.hasRight(request, "basAccount", GlobalVal.MENU_FUNCTION.VIEW)) {
			...
			return "basInfo/report/reportTest.jsp";
		} else {
	...
	public String views(HttpServletRequest request,Model model,String fileName) {
		if (SysUtil.hasRight(request, "basAccount", GlobalVal.MENU_FUNCTION.VIEW)) {
			Integer id=SysUtil.getLoginUserId(request);
			String realPath=request.getSession().getServletContext().getRealPath("/");
			
			//String path = request.getContextPath()+"/resources/grf/";
			//System.out.println("_______________________________________________path__::"+path);
